...
function JobListItem(props: any) {
  ...
  return (
    <div
      className={`shadow-lg rounded-sm border px-5 py-4 ${props.type === "Featured"
    ...
    >
      <div className="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
        ...
        <div className="flex items-center space-x-4 pl-10 md:pl-0">
          ...
          {props.type && (
            <div
              className={`text-xs inline-flex font-medium rounded-full text-center px-2.5 py-1 ${props.type === "Featured"
